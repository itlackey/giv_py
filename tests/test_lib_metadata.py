...
class TestProjectMetadataInit:
    ...
    def test_project_metadata_custom_init(self):
        ...
        metadata = ProjectMetadata(custom_root)
        assert metadata.project_root == custom_root
...
class TestProjectMetadataStaticMethods:
    ...
    def test_static_get_title(self, mock_get_title, mock_init):
...
""")
            ...
            metadata = ProjectMetadata(project_root)
            assert metadata.get_title() == "complex-project"
            assert metadata.get_version() == "2.1.0"
...
""")
            ...
            metadata = ProjectMetadata(project_root)
            assert metadata.get_title() == "complex-setup"
            assert metadata.get_version() == "3.2.1"
...
""")
            ...
            metadata = ProjectMetadata(project_root)
            assert metadata.get_title() == "complex-node-app"
            assert metadata.get_version() == "1.5.2"
...
""")
            ...
            metadata = ProjectMetadata(project_root)
            assert metadata.get_title() == "giv-cli"
...
""")
            ...
            metadata = ProjectMetadata(subproject)
            assert metadata.get_title() == "@monorepo/cli"
            assert metadata.get_version() == "2.1.0"
